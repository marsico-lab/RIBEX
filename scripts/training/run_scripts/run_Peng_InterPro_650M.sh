...
#SBATCH --job-name=TRAIN_P_I_650M
...
# Peng & esm1b: 10 epochs ~ 40min

#Pre training
python3 scripts/training/train.py -M Peng -DS InterPro_human_pre-training.pkl -lm esm1b_t33_650M_UR50S -ef "InterPro" -S 2023 -e 30 -bs 512 --patience 5

#Fine tune
python3 scripts/training/train.py -M Peng -DS InterPro_human_fine-tuning.pkl -lm esm1b_t33_650M_UR50S -ef "InterPro" --checkpoint-folder "LM=esm1b_t33_650M_UR50S-E=InterPro-S=2023-E=30-BS=512" -S 2023 -e 10 -bs 512 --patience 3
