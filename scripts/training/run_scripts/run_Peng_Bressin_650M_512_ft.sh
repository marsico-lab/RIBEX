...
#Fine tune
python3 scripts/training/train.py -M Peng -DS bressin19_human_fine-tuning.pkl -lm esm1b_t33_650M_UR50S -ef "bressin19" --checkpoint-folder "LM=esm1b_t33_650M_UR50S-E=bressin19-S=2023-E=100-BS=512" -S 2023 -e 100 -bs 512 --patience 20
python3 scripts/training/train.py -M Peng -DS bressin19_human_fine-tuning.pkl -lm esm1b_t33_650M_UR50S -ef "bressin19" --checkpoint-folder "LM=esm1b_t33_650M_UR50S-E=bressin19-S=2024-E=100-BS=512" -S 2024 -e 100 -bs 512 --patience 20
