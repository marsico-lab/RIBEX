#!/bin/bash
# Master script to run complete dataset comparison across multiple seeds
#
# This submits:
...
DATASET_NAME="$1"
DATASET="${DATASET_NAME}_human_fine-tuning.pkl"
...
echo "================================================================================"
echo "${DATASET_NAME} DATASET COMPARISON - MULTI-SEED PAIRED EXPERIMENT"
echo "================================================================================"
echo ""
...
#SBATCH -J ${DATASET_NAME}_generate_splits
#SBATCH --output=/path/to/RBP_IG/scripts/sbatch_logs/${DATASET_NAME}_generate_splits_%j.txt
#SBATCH --error=/path/to/RBP_IG/scripts/sbatch_logs/${DATASET_NAME}_generate_splits_%j.txt
...
echo "================================================================================"
echo "GENERATING SHARED SPLITS FOR ALL SEEDS - ${DATASET_NAME}"
echo "================================================================================"
echo ""
echo "Seeds: \${SEEDS[@]}"
echo ""
...
#SBATCH -J ${DATASET_NAME}_FiLM_seed_${SEED}
#SBATCH --output=/path/to/RBP_IG/scripts/sbatch_logs/${DATASET_NAME}_FiLM_PE_seed_${SEED}_%j.txt
#SBATCH --error=/path/to/RBP_IG/scripts/sbatch_logs/${DATASET_NAME}_FiLM_PE_seed_${SEED}_%j.txt
...
echo "================================================================================"
echo "FiLM PE EXPERIMENTS - ${DATASET_NAME} - SEED \${SEED}"
echo "================================================================================"
echo ""
...
for LM_NAME in "\${FILM_PE_MODELS[@]}"; do
    ...
    # Verify splits exist
    SPLIT_TRAIN="/path/to/RBP_IG_storage/data/splits/\${DATASET_NAME}_human_fine-tuning_film_pe_seed_\${SEED}_\${LM_NAME}__ft_train.tsv"
    SPLIT_VAL="/path/to/RBP_IG_storage/data/splits/\${DATASET_NAME}_human_fine-tuning_film_pe_seed_\${SEED}_\${LM_NAME}__ft_val.tsv"
    ...
    python3 scripts/training/train.py -M FiLM_PE -D "\$DEVICES" -DS "\${DATASET_NAME}_human_fine-tuning.pkl" -lm "\$LM_NAME" -ef "\$EMB" -S "\$SEED" -e "\$FILM_EPOCHS" -bs "\$BS" -lr "\$LR" --pe_dim "\$PE_DIM" --patience 5 --keep_small_val_batches
...
#SBATCH -J ${DATASET_NAME}_LoRA_seed_${SEED}
#SBATCH --output=/path/to/RBP_IG/scripts/sbatch_logs/${DATASET_NAME}_LoRA_seed_${SEED}_%j.txt
#SBATCH --error=/path/to/RBP_IG/scripts/sbatch_logs/${DATASET_NAME}_LoRA_seed_${SEED}_%j.txt
...
echo "================================================================================"
echo "LoRA EXPERIMENTS - ${DATASET_NAME} - SEED \${SEED}"
echo "================================================================================"
echo ""
...
for LM_NAME in "\${LORA_MODELS[@]}"; do
    ...
    # Verify splits exist
    SPLIT_TRAIN="/path/to/RBP_IG_storage/data/splits/\${DATASET_NAME}_human_fine-tuning_lora_seed_\${SEED}_\${LM_NAME}__ft_train.tsv"
    SPLIT_VAL="/path/to/RBP_IG_storage/data/splits/\${DATASET_NAME}_human_fine-tuning_lora_seed_\${SEED}_\${LM_NAME}__ft_val.tsv"
    ...
    # Run LoRA training
    python3 scripts/training/train.py -M Lora -D "\$DEVICES" -DS "\${DATASET_NAME}_human_fine-tuning.pkl" -lm "\$LM_NAME" -ef "\$EMB" -S "\$SEED" -bs "\$BS" --lora_per_device_bs "\$LORA_BS" --lora_learning_rate "\$LR" --lora_num_train_epochs "\$LORA_EPOCHS" --pe_dim "\$PE_DIM" --patience 10
...
echo ""
echo "================================================================================"
echo "ALL JOBS SUBMITTED - ${DATASET_NAME}"
echo "================================================================================"
echo ""
...
echo ""
echo "Check logs in:"
echo "  \$HOME/RBP_IG/scripts/sbatch_logs/${DATASET_NAME}_*"
echo ""
